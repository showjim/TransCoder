...
TOK_NO_SPACE_BEFORE = {',', ';'}
# clang.cindex.Config.set_library_file('/usr/lib/x86_64-linux-gnu/libclang-cpp.so.10')
clang.cindex.Config.set_library_path('/usr/lib/llvm-10/lib') #('/usr/lib/llvm-7/lib/')
